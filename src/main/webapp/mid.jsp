...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="bigContainer">
      ...
      <p class="tip" >Remember you will only hear the song for 15 seconds. Click 'Play Song' when you are ready.</p>
      
      <audio id="myAudio">
</audio>
 <div class="wBtnv2">
      <button type="button" name="button" class="playBtn" onclick="playSegment(45.0 , 60.0, this)"><span class="howTxt" >Play Song</span></button>
      </div>
